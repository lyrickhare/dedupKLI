...
def main(src_path, dest_path):
    ...
    for folder in myFolder:
        ...
        img_path = list(Path(folder).rglob("*")) # Input Images
        img_path_str = [str(i) for i in img_path] # typecasting to string


        segregated_dict = segregateNN.segregate(img_path_str) #Getting the classified dictionary
